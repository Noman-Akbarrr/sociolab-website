...
export type PageOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"path" | "title" | "description" | "data" | "published" | "updatedAt" | "createdAt", ExtArgs["result"]["page"]>
...
export interface PageDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const pageWithPathOnly = await prisma.page.findMany({ select: { path: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Pages and only return the `path`
   * const pageWithPathOnly = await prisma.page.createManyAndReturn({
   *   select: { path: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Pages and only return the `path`
   * const pageWithPathOnly = await prisma.page.updateManyAndReturn({
   *   select: { path: true },
   *   where: {
   *     // ... provide filter here
   *   },
